...
public class Jim_GrandLassoBeingUsed : IState
{
    ...
    public Jim_GrandLassoBeingUsed(TurnBasedManager turnBaseManager)
    {
    ...
    public void Enter()
    {
        ...
        m_TurnBaseManager.StartCoroutine(m_TurnBaseManager.GrandLassoAttack(m_TurnBaseManager.Selected, unitInRange));
